...
export function createMockData(): PlanningData {
  ...
  return {
    ...
    teams: [
      { ...base('equipe-1'), workId: 'obra-1', company: 'SM MARTINS', name: 'Revestimentos', weeklyCapacity: 2 },
      { ...base('equipe-2'), workId: 'obra-1', company: 'ATR ENG', name: 'Elétrica', weeklyCapacity: 3 },
    ],
    progressEntries: [],
    commitments: [],
    baselines: [],
