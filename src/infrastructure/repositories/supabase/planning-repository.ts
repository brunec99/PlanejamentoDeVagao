...
const TABLES = ['works', 'locations', 'production_sequences', 'wagons', 'activities', 'terminality_criteria', 'pending_items', 'restrictions', 'releases', 'terminality_debts', 'teams', 'progress_entries', 'weekly_commitments', 'baselines', 'activity_dependencies', 'medium_term_plans', 'plan_tasks', 'plan_dependencies', 'ifc_models', 'ifc_model_versions', 'link_rules', 'history_events', 'profiles'] as const;
