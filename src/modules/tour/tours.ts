...
export const tours: Record<TourKey, TourStep[]> = {
  ...
  longoPrazo: [
    { title: 'Aba 1 · Cronograma de longo prazo', body: 'O macro da obra em duas visões: o Planejador, onde o cronograma de longo prazo é preenchido aqui mesmo, e a visão dos vagões, com a Linha de Balanço das atividades dos vagões, o módulo de restrições, a curva de avanço e as linhas de base.' },
    { target: 'work-nav', title: 'As seis abas', body: 'As seis abas numeradas seguem o planejamento do macro para a semana — longo prazo, vagões, médio e curto prazo — e depois o modelo: federado e BIM 4D. Abaixo delas, em Apoio, ficam os arquivos IFC, as dívidas, as integrações e as configurações da obra.' },
    { target: 'longo-visoes', title: 'Planejador ou vagões', body: 'O Planejador é o cronograma de longo prazo, e é ele o responsável pelas atividades dos vagões: "Gerar vagões" transforma cada serviço × pavimento em atividades de vagão. "Vagões e restrições" mostra essas atividades, só para leitura, junto do módulo de restrições.' },
    { target: 'longo-planejador-acoes', title: 'Montar o plano', body: 'Cada serviço percorre uma faixa de pavimentos com duração por pavimento e ritmo. As predecessoras empurram as datas sozinhas; "Recalcular" puxa tudo para a data mínima, tirando as folgas. O plano é salvo automaticamente. "Gerar vagões" leva o plano salvo para os vagões, com prévia do que muda; vagões já liberados nunca mudam. Importar aceita o arquivo da ferramenta antiga do App-ATR.' },
    { target: 'longo-planejador-canvas', title: 'Fluxograma que vira Linha de Balanço', body: 'No fluxograma, cada cartão é um serviço e as setas são as predecessoras. Expanda um cartão para ver os pavimentos dele, ou a obra inteira em Linha de Balanço — na Linha de Balanço, arraste um serviço para reprogramá-lo.' },
    ...
    { target: 'longo-board', title: 'Módulo de restrições', body: 'Cada restrição é ligada a uma atividade e a um lead time. O limite de resolução não é digitado: sai do início previsto da atividade menos esse lead time. Abra o card para ver a descrição completa e de onde veio a data.' },
  ...
  medioPrazo: [
    { title: 'Aba 3 · Cronograma de médio prazo', body: 'Um cronograma por mês, com horizonte de três meses, no layout do MS Project. O cronograma de cada mês nasce como cópia do anterior, que fica guardado como estava.' },
    ...
    { target: 'medio-gantt', title: 'Tabela e Gantt', body: 'A tabela à esquerda e o Gantt de acompanhamento à direita andam juntos: barra azul é o previsto atual, a cinza embaixo é a linha de base, o colchete é o resumo e o losango é o marco (0 dias). A linha 0 resume o cronograma inteiro. As datas são agendadas automaticamente: mudar duração ou predecessora empurra as sucessoras. Digitar um início numa tarefa com predecessoras vira "Não iniciar antes de"; apagar o início devolve a data à rede.' },
    ...
    { target: 'medio-gantt', title: 'Cadeado, predecessoras e datas reais', body: 'A grade abre bloqueada de propósito: em reunião o risco é a edição acidental. As predecessoras usam o Id da linha, como no Project: 12, 12;14, 27TI+6 dias, 5TT-1 dia. Lançar % concluída preenche o Início real; 100% preenche o Término real. Data real prende a tarefa: a rede não a move mais. Nada vai ao banco até "Revisar e salvar", com motivo.' },
    { target: 'medio-gantt', title: 'Item e subitem', body: 'Recue uma linha (com o botão ou com Alt+Shift+→, como no MS Project) para ela virar subitem da linha de cima. O recuo leva os subitens dela junto. Um item com subitens passa a ser resumo: início, término e avanço dele são os dos subitens, e por isso essas células ficam travadas. Excluir um item exclui os subitens.' },
    { target: 'medio-resources', title: 'Alocação e superalocação', body: 'A carga de cada equipe semana a semana, contra a capacidade cadastrada: verde abaixo, âmbar no limite, vermelho acima. Clique numa célula para ver quais tarefas e atividades causam a carga daquela semana. Capacidade é número de atividades simultâneas por semana, não pessoas nem horas.' },
    { target: 'medio-baseline', title: 'Linha de base e atrasos', body: 'Escolha o plano e uma das linhas de base congeladas dele. A tela calcula, em dias úteis do calendário do plano, a variação de início e de término de cada tarefa, o maior atraso e quanto o término do plano se moveu. Atrasada é quem termina depois da base.' },
  ],
  curtoPrazo: [
    { title: 'Aba 4 · Cronograma de curto prazo', body: 'A planilha da semana, que se sustenta sozinha: nada aqui depende do plano do mês nem de cadastro feito em outra tela. Compromissos da semana, cumprimento, PPC e causas de não cumprimento.' },
  ...
  planejamento: [
    { title: 'Aba 2 · Planejamento por vagões', body: 'Aqui os vagões desta obra ficam organizados em sequências de produção. Cada vagão é um período fixo (o "takt") que reúne várias atividades.' },
  ...
  federacao: [
    { title: 'Aba 5 · Modelo federado', body: 'Reúna versões dos modelos da obra e explore o conjunto sem depender do planejamento 4D.' },
  ...
  quatroD: [
    { title: 'Aba 6 · BIM 4D', body: 'Anima o cronograma de longo prazo sobre o modelo federado: reproduza, pause ou arraste a linha do tempo nos modos Planejado, Executado ou Planejado × executado. O avanço parcial é um tom do serviço inteiro, nunca verificação por elemento.' },
