...
export const tours: Record<TourKey, TourStep[]> = {
  ...
  longoPrazo: [
    { title: 'Aba 1 · Cronograma de longo prazo', body: 'Visão macro da obra em Linha de Balanço, o módulo de restrições, a curva de avanço e as linhas de base salvas para comparar com o realizado.' },
  ...
  medioPrazo: [
    { title: 'Aba 3 · Cronograma de médio prazo', body: 'O plano do mês, escrito do zero: um plano novo a cada mês, com o cadastro de equipes que também abastece a planilha semanal.' },
