...
Build de produção, TypeScript e 129 testes aprovados. As migrações `0020` e `0021` ainda precisam ser aplicadas antes da promoção desta entrega para produção. Veja o [registro de implantação](docs/implantacao-2026-09-19.md) e a sequência de atualização do banco e publicação.
